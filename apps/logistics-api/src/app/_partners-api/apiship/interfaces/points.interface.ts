export interface ApishipListsPointResponse {
  rows: IApiship_listsPoints[];
  //rows: IApiship_listsPoints_short[];
  meta: Meta;
}
...
/*
export interface IApiship_listsPoints_short {
  id: string;
  lat: number;
  lng: number;
}*/

export interface IApiship_listsPoints {
  id: string;
